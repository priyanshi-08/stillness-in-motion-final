    ...
    return (
        <div className='md:w-[80%] mx-auto my-28'>
            <div className>
                ...
                {
                    instructors ? <>
                        <div key = {1} className={`grid mb-28 md:grid-cols-1 lg:grid-cols-${instructors.length} w-[90%] gap-4 mx-auto`}>
                            {
                                instructors.slice(0, 4)?.map((instructor, i) => (
                                 ...
                                 flex-col shadow-md py-8 px-10 md:px-8 rounded-md dark:shadow-white'>
                                        ...
                                        <div className='text-center'>
                                            ...
                                            <p className='text-gray-500'>Total Students: {instructor?.totalEnrolled}</p>
                                        </div>
                                    </div>
                                ))
                            }
